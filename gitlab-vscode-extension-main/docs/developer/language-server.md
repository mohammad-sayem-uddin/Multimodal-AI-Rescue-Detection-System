...
This document explains how to run the extension and the
...
1. Run `npm run bundle` to create the Language Server bundle file used by the extension.
1. Run `asdf install`
1. Run `yalc publish`
1. Go to the folder with the extension project
