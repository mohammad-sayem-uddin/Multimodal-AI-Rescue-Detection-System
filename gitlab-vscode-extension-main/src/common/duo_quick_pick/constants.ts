...
export const DOCUMENTATION_URL = 'https://docs.gitlab.com/user/gitlab_duo/';
...
export const SANDBOX_STATUS_ENABLED = 'Agent Sandboxing: Enabled';
export const SANDBOX_STATUS_DISABLED = 'Agent Sandboxing: Disabled';
export const SANDBOX_STATUS_UNSUPPORTED = 'Agent Sandboxing: Unsupported';
export const SANDBOX_STATUS_MISSING_DEPS = 'Agent Sandboxing: Missing Dependencies';
export const ENABLE_SANDBOX = 'Enable Agent Sandboxing';
export const DISABLE_SANDBOX = 'Disable Agent Sandboxing';
