  ...
  async init(context: ExtensionContext): Promise<void> {
    ...
    try {
      ...
      throw new UserFriendlyError(
        `The GitLab extension can't access the OS Keychain. See this [existing issue](https://gitlab.com/gitlab-org/gitlab-vscode-extension/-/issues/580) for more information.`,
        error,
      );
    }
  }
