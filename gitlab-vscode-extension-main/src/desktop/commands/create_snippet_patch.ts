...
- In VS Code with the GitLab extension installed:
...
*This snippet was created with the [GitLab for VS Code extension](https://marketplace.visualstudio.com/items?itemName=GitLab.gitlab-workflow).*
`;
